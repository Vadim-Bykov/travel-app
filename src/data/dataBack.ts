...
const data = {
  ...
  userData: [
    ...
    },
    {
      id: 5,
      shortInfo: {
        en: 'France is a transcontinental state that includes the main territory in Western Europe and a number of overseas regions and territories. The population is 62 814 233 people in the metropolis and 67 848 156 people - including overseas possessions.',
        ru: 'Франция — трансконтинентальное государство, включающее основную территорию в Западной Европе и ряд заморских регионов и территорий. Население — 62 814 233 человек в метрополии и 67 848 156 человек — с учётом заморских владений.',
        de: 'Frankreich ist ein transkontinentaler Staat, der das Hauptgebiet Westeuropas und eine Reihe von Regionen und Gebieten in Übersee umfasst. Die Bevölkerung beträgt 62 814 233 Menschen in der Metropole und 67 848 156 Menschen - einschließlich ausländischer Besitztümer.',
      },
      video: {
        en: '',
        ru: '',
      ...
      sightseeings: [
        ...
        },
        {
          ...
          shortInfo: {
            ...
            de: "Eine ehemalige Festung, einst ein Palast und heute ein Museum - der Louvre in Paris hat all diese Veränderungen in seinem Leben erlebt und ist zum meistbesuchten Museum geworden, in das jedes Jahr Millionen von Menschen aus aller Welt kommen. Die entfernteste Vergangenheit und Gegenwart sind hier in Hunderttausenden von Exponaten zu einem Ganzen verflochten, von denen wir nur 35.000 mit eigenen Augen sehen können.",
          }
        },
        {
          img: versailles,
          ...
          shortInfo: {
            en: "The Versailles Palace is an outstanding masterpiece in the history of world architecture. The layout of the Palace of Versailles park also represents the highest achievement in park art in France. Magnificent compositions of gardens and alleys, exquisite greenhouses full of diverse vegetation, picturesque fountains of the Palace of Versailles - all this became a real standard in European architecture in the 18th century.",
            ...
            de: 'Das Schloss Versailles ist ein herausragendes Meisterwerk in der Geschichte der Weltarchitektur. Die Gestaltung des Parks des Schlosses von Versailles ist auch die höchste Errungenschaft in der Parkkunst in Frankreich. Prächtige Kompositionen aus Gärten und Gassen, exquisite Gewächshäuser voller vielfältiger Vegetation, malerische Brunnen des Schlosses von Versailles - all dies wurde im 18. Jahrhundert zu einem echten Standard in der europäischen Architektur.',
          }
        },
        {
          img: azure,
          ...
          de: "Cote d'Azur'",
          shortInfo: {
            en: "The Cote d'Azur is not just a tourist attraction in France and a place of excellent rest, but also a land of amazing contrasts. For example, warm sunny beaches contrast with the snow-capped coastal Alps.",
            ru: 'Лазурный берег — это не просто излюбленная многими туристами достопримечательность Франции и место отличного отдыха, но и земля удивительных контрастов. Так, например, тёплые солнечные пляжи здесь контрастируют с заснеженными приморскими Альпами',
            de: "Die Côte d'Azur ist nicht nur eine Touristenattraktion in Frankreich und ein Ort der hervorragenden Erholung, sondern auch ein Land der erstaunlichen Kontraste. Zum Beispiel stehen warme, sonnige Strände im Kontrast zu den schneebedeckten Küstenalpen.",
          }
        },
        {
          img: fontainebleau,
          ...
          shortInfo: {
            ...
            ru: 'Сооружение включает и изящные башенки, и приземистые постройки, поэтому резиденцию часто сравнивают с разными по форме и высоте фужерами. Само название дворца переводится как «прекрасный фонтан» и происходит от названия родника, из которого некогда сам Наполеон Бонапарт черпал силы.',
            de: 'Die Struktur umfasst sowohl anmutige Türme als auch gedrungene Gebäude, sodass die Residenz häufig mit Weingläsern unterschiedlicher Form und Höhe verglichen wird. Der Name des Palastes bedeutet "schöner Brunnen" und leitet sich vom Namen der Quelle ab, aus der einst Napoleon Bonaparte selbst Kraft schöpfte.',
          }
        },
        {
          img: disneyland,
          ...
          shortInfo: {
            ...
            de: 'Dieser gigantische, weltbekannte Unterhaltungskomplex umfasst Parks, Hotels, fabelhafte "Länder" und ganze Wohngebiete. In Bezug auf die Besucherzahlen übertrifft Disneyland alle Sehenswürdigkeiten in den Ländern der Alten Welt. Die Gesamtfläche des grandiosen Märchenkomplexes beträgt 1.943 Hektar, und mehr als 12,5 Millionen Besucher ruhen sich jährlich aus und haben Spaß auf seinem Territorium.',
          }
        },
      ],
    },
    {
      id: 6,
      shortInfo: {
        en: 'China is a state in East Asia. It ranks third in the world in terms of territory (9,598,962 km2), behind Russia and Canada, and in terms of population - 1,415,515,674 inhabitants - the first. The majority of the population is ethnic Chinese.',
        ru: 'Китай — государство в Восточной Азии. Занимает третье место в мире по территории (9 598 962 км2), уступая России и Канаде, а по численности населения — 1 415 515 674 жителей — первое. Большинство населения — этнические китайцы.',
        de: 'China ist ein Staat in Ostasien. Es liegt weltweit an dritter Stelle in Bezug auf das Territorium (9 598 962 km2) nach Russland und Kanada und in Bezug auf die Bevölkerung - 1 415 515 674 Einwohner - an erster Stelle. Die Mehrheit der Bevölkerung sind ethnische Chinesen.',
      },
      video: {
        en: '',
        ru: '',
      ...
      sightseeings: [
        ...
        shortInfo: {
          en: "The Great Wall of China is an impressive landmark in China, a grandiose monument of antiquity and is considered the longest structure in the world built for defense purposes. It passes through North China for almost 9 thousand kilometers.",
          ru: 'Великая Китайская стена является внушительной достопримечательностью Китая, грандиозным памятником древности и считается самым длинным сооружением в мире, возведённым в целях обороны. Она проходит по Северному Китаю на протяжении почти 9 тыс. километров.',
          de: 'Die Chinesische Mauer ist ein beeindruckendes Wahrzeichen Chinas, ein grandioses Denkmal der Antike und gilt als das längste Bauwerk der Welt, das zu Verteidigungszwecken errichtet wurde. Es führt fast 9.000 Kilometer durch Nordchina.',
        }
        },
        {
          img: potalaPalace,
          ...
          de: 'Potala-Palast',
          shortInfo: {
            en: "The Royal Palace and the Buddhist temple complex of Lhasa, located in Tibet at an altitude of 3.8 km above sea level, is an important landmark in China among the shrines. The palace served as the main residence of the Dalai Lama. No palace in the world is located as high in the mountains as the Potala.",
            ru: 'Царский дворец и буддийский храмовый комплекс Лхаса, расположенный в Тибете на высоте 3,8 км над уровнем моря, представляет собой важную достопримечательность Китая в числе святынь. Дворец выполнял роль основной резиденции Далай-Ламы. Ни один дворец в мире не расположен так высоко в горах, как Потала.',
            de: "Der Königspalast und der buddhistische Tempelkomplex von Lhasa in Tibet auf einer Höhe von 3,8 km über dem Meeresspiegel sind ein wichtiges Wahrzeichen Chinas unter den Schreinen. Der Palast diente als Hauptresidenz des Dalai Lama. Kein Palast der Welt liegt so hoch in den Bergen wie der Potala.",
          }
        },
        {
          img: terracottaArmy,
          ...
          de: 'Terracotta Armee',
          shortInfo: {
            en: "This is a military garrison of many thousands, but not military, but clay statues with a height of 1.9 - 1.95 meters. This wonder of the world is known as the Terracotta Army, and its history goes back more than 2 thousand years. In total, the underground burials include at least 8099 statues of Chinese warriors and their horses, made of terracotta clay.",
        ...
        },
        {
          ...
          shortInfo: {
            en: "The landmark of China in the form of a giant Buddha is located at the confluence of three rivers, the oncoming streams of which form dangerous whirlpools. Many local residents and fishermen perished in these streams, therefore, according to legend, the monk Hai Tun decided to tame the elements by cutting out the image of a deity in the rock.",
            ru: 'Достопримечательность Китая в виде гигантского Будды располагается в месте слияния трёх рек, встречные потоки которых образуют опасные водовороты. В этих потоках погибло немало местных жителей и рыбаков, поэтому, согласно преданию, монах Хай Тун решил укротить стихию, вырубив в скале образ божества.',
        ...
        },
        {
          ...
          de: 'Hongkong',
          shortInfo: {
            en: 'Hong Kong is a city on the southern coast of China, located on more than 260 islands and has its own special social, economic and political status. Today it is also a major financial and business center that plays a leading role on the world stage.',
            ru: 'Гонконг — город на южном побережье Китая, расположенный более чем на 260 островах и имеющий свой особый социальный, экономический и политический статус. Сегодня это также крупный финансовый и деловой центр, который играет ведущие роли на мировой арене.',
            de: 'Hongkong ist eine Stadt an der Südküste Chinas, die auf mehr als 260 Inseln liegt und einen besonderen sozialen, wirtschaftlichen und politischen Status hat. Heute ist es auch ein wichtiges Finanz- und Geschäftszentrum, das auf der Weltbühne eine führende Rolle spielt.',
          }
        },
        {
          img: shaolin,
    ...
    },
    {
      id: 7,
      shortInfo: {
        en: 'The United States of America is a state in North America. Area - 9.5 million km² (4th place in the world). Population - about 329 million people (3rd place in the world). The United States has a federal form of structure, administratively divided into 50 states and the Federal District of Columbia.',
        ru: 'Соединённые Штаты Америки — государство в Северной Америке. Площадь — 9,5 млн км² (4-е место в мире). Население — около 329 млн человек (3-е место в мире). США имеют федеративную форму устройства, административно делятся на 50 штатов и федеральный округ Колумбия.',
        de: 'Die Vereinigten Staaten von Amerika sind ein Staat in Nordamerika. Fläche - 9,5 Millionen km² (4. Platz in der Welt). Bevölkerung - ungefähr 329 Millionen Menschen (3. Platz in der Welt). Die Vereinigten Staaten haben eine föderale Struktur, die administrativ in 50 Staaten und den District of Columbia unterteilt ist.',
      },
      video: {
        en: '',
        ru: '',
      ...
      sightseeings: [
        ...
        },
        {
          ...
          de: 'Zentralpark',
          shortInfo: {
            en: "It is an oasis of tranquility in Manhattan's busy business. The green area is 4 km long and 800 meters wide. The park was opened in 1859. Tens of thousands of workers improved the territory for another 20 years. About 5 million trees were planted, and the land was brought from ecologically clean areas.",
            ru: 'Это оазис спокойствия в бурном деловом потоке Манхэттена. Зеленая зона раскинулась на 4 км в длину и 800 метров в ширину. Открытие парка состоялось в 1859 году. Десятки тысяч рабочих еще 20 лет облагораживали территорию. Было посажено около 5 млн деревьев, а землю привозили из экологически чистых зон.',
            de: "Es ist eine Oase der Ruhe im geschäftigen Geschäft von Manhattan. Die Grünfläche ist 4 km lang und 800 m breit. Der Park wurde 1859 eröffnet. Zehntausende Arbeiter verbesserten das Territorium für weitere 20 Jahre. Etwa 5 Millionen Bäume wurden gepflanzt und das Land aus ökologisch sauberen Zonen gebracht.",
          }
        },
        {
          img: chinaTown,
          ...
          de: 'Chinatown',
          shortInfo: {
            en: "In Chinatown, a popular habitat for the Chinese diaspora, a stone's throw from the fashionable areas of the Big Apple, time slows down. Ethnic flavor shines through in this place in everything: traditional elements of the architecture of the Middle Kingdom, red lanterns, signs written in hieroglyphs, noisy crowds of immigrants from China, Vietnam and other Far Eastern countries.",
            ...
            de: 'In Chinatown, einem beliebten Lebensraum für die chinesische Diaspora, nur einen Steinwurf von den modischen Gegenden des Big Apple entfernt, verlangsamt sich die Zeit. Ethnisches Flair kommt an diesem Ort in allem zum Ausdruck: traditionelle Elemente der Architektur des Reiches der Mitte, rote Laternen, Zeichen in Hieroglyphen, laute Massen von Einwanderern aus China, Vietnam und anderen fernöstlichen Ländern.',
          }
        },
        {
          img: whiteHouse,
        ...
        },
        {
          ...
          shortInfo: {
            ...
            de: 'Das Gebäude ist das größte aller Bürogebäude der Welt. Es hat die Form eines Pentagramms, weshalb es so genannt wird. Die Gesamtfläche des Komplexes beträgt 600.000 Quadratmeter. Meter. Es hat 7 Etagen, von denen 2 unterirdisch sind. Die Höhe des Gebäudes beträgt 23 Meter. Die Fläche des Hofes beträgt 21 Tausend Quadratmeter. Meter. Hier befindet sich das Verteidigungsministerium des Landes.',
          }
        },
        {
          img: lasVegas,
    ...
    },
    {
      ...
      shortInfo: {
        ...
        de: 'Japan ist ein Inselstaat in Ostasien. Das Hotel liegt im Pazifischen Ozean östlich des Japanischen Meeres, China, Nord- und Südkorea, Russland. Das Hotel liegt im japanischen Archipel, das aus 6852 Inseln besteht. Die vier größten Inseln - Honshu, Hokkaido, Kyushu und Shikoku - machen 97% der Gesamtfläche des Archipels aus. Mit fast 126 Millionen Einwohnern liegt Japan weltweit an elfter Stelle.',
      },
      video: {
        en: '',
        ru: '',
      ...
      sightseeings: [
        ...
        },
        {
          ...
          de: 'Himmlischer Baum',
          shortInfo: {
            en: "Tokyo Sky Tree is the second tallest TV tower in the world. This graceful architectural structure of glass, concrete and metal soared into the sky, thanks to the efforts of experienced designers and engineers. The height of the building is 634 meters.",
            ru: 'Небесное дерево Токио – вторая по высоте телебашня в мире. Это изящное архитектурное строение из стекла, бетона и металла взметнулось ввысь, благодаря стараниям опытных конструкторов и инженеров. Высота сооружения составляет 634 метра.',
            de: "Tokyo Sky Tree ist der zweithöchste Fernsehturm der Welt. Diese anmutige architektonische Struktur aus Glas, Beton und Metall stieg dank der Bemühungen erfahrener Designer und Ingenieure in den Himmel. Die Höhe des Gebäudes beträgt 634 Meter.",
          }
        },
        {
          img: odaiba,
          ...
          de: 'Müllinsel',
          shortInfo: {
            en: "The futuristic city of the future is located on Odaiba Island in Tokyo Harbor. It is a pedestrian's paradise, a holiday city with thousands of lights. Why was the island named Garbage? In 1979, it was merged with a garbage dump, which did not prevent the original place from developing at a rapid pace.",
        ...
        },
        {
          ...
          shortInfo: {
            ...
            de: 'Das Symbol des Landes der aufgehenden Sonne ist der heilige Berg Fuji. Was in Japan außerhalb der Hauptstadt zu besuchen? Sie sollten auf jeden Fall den jungen Fujiyama-Vulkan in der Nähe sehen. Die Japaner glauben, dass der Berg von den Göttern aus dem Chaos geschaffen wurde. Es ist das bekannteste Wahrzeichen des Landes. Der majestätische Berggipfel erhebt sich in 3776 Metern Höhe in den Himmel. Viele Pilger besteigen den Fuji.',
          }
        },
        {
          img: goldenPavilion,
